...
using Administration = PHC.Administration.Pages;

[assembly: NavigationMenu(9000, "Administration", icon: "fa-desktop")]
[assembly: NavigationLink(9000, "Administration/Exceptions Log", url: "~/errorlog.axd", permission: PHC.Administration.PermissionKeys.Security, icon: "icon-ban", Target = "_blank")]
