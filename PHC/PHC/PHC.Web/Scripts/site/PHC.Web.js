...
(function (PHC) {
    ...
    })(Organization = PHC.Organization || (PHC.Organization = {}));
})(PHC || (PHC = {}));
var PHC;
(function (PHC) {
    var Organization;
...
(function (PHC) {
    ...
    (function (Northwind) {
        var TerritoryDialog = (function (_super) {
            ...
            TerritoryDialog.prototype.getLanguages = function () {
                return PHC.LanguageList.getValue();
            };
    ...
    })(Northwind = PHC.Northwind || (PHC.Northwind = {}));
})(PHC || (PHC = {}));
var PHC;
(function (PHC) {
    var Northwind;
    ...
    (function (Northwind) {
        var ProductGrid = (function (_super) {
            ...
            ProductGrid.prototype.getButtons = function () {
                ...
                buttons.push(PHC.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    service: Northwind.ProductService.baseUrl + '/ListExcel',
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    separator: true
                }));
                buttons.push(PHC.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
    ...
    (function (Northwind) {
        var OrderDialog = (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                ...
                buttons.push(PHC.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        PHC.Common.ReportHelper.execute({
                            reportKey: 'Northwind.OrderDetail',
                            params: {
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: PHC.Authorization.userDefinition.DisplayName,
    ...
    (function (Northwind) {
        var CustomerDialog = (function (_super) {
            ...
            function CustomerDialog() {
                ...
                PHC.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
...
(function (PHC) {
    ...
    })(Membership = PHC.Membership || (PHC.Membership = {}));
})(PHC || (PHC = {}));
var PHC;
(function (PHC) {
    var Membership;
...
(function (PHC) {
    ...
    })(Meeting = PHC.Meeting || (PHC.Meeting = {}));
})(PHC || (PHC = {}));
var PHC;
(function (PHC) {
    var Meeting;
        ...
        var MeetingAttendeeEditor = (function (_super) {
            ...
            MeetingAttendeeEditor.prototype.createToolbarExtensions = function () {
                ...
                Serenity.Widget.create({
                    type: Serenity.LookupEditor,
                    options: {
                        lookupKey: PHC.Organization.ContactRow.lookupKey
                    },
                    ...
                    init: function (w) { return w.changeSelect2(function (x) {
                        if (Q.isEmptyOrNull(w.value))
                            return;
                        var contact = PHC.Organization.ContactRow.getLookup().itemById[Q.toId(w.value)];
                        w.value = null;
                        if (!contact)
                            return;
...
(function (PHC) {
    var Default;
    (function (Default) {
        var UsuarioDialog = (function (_super) {
    ...
    })(Default = PHC.Default || (PHC.Default = {}));
})(PHC || (PHC = {}));
var PHC;
(function (PHC) {
    var Default;
    (function (Default) {
        var UsuarioGrid = (function (_super) {
...
(function (PHC) {
    var Default;
    (function (Default) {
        var TareaDialog = (function (_super) {
...
(function (PHC) {
    var Default;
    (function (Default) {
        var RequerimientoPuestoDialog = (function (_super) {
...
(function (PHC) {
    var Default;
    (function (Default) {
        var RequerimientoPuestoGrid = (function (_super) {
...
(function (PHC) {
    var Default;
    (function (Default) {
        var RequerimientoDialog = (function (_super) {
...
(function (PHC) {
    var Default;
    (function (Default) {
        var RequerimientoGrid = (function (_super) {
...
(function (PHC) {
    var Default;
    (function (Default) {
        var PuestoTareaDialog = (function (_super) {
...
(function (PHC) {
    var Default;
    (function (Default) {
        var PuestoTareaGrid = (function (_super) {
...
(function (PHC) {
    var Default;
    (function (Default) {
        var PuestoDialog = (function (_super) {
...
(function (PHC) {
    var Default;
    (function (Default) {
        var PuestoGrid = (function (_super) {
...
(function (PHC) {
    var Default;
    (function (Default) {
        var NivelDialog = (function (_super) {
...
(function (PHC) {
    var Default;
    (function (Default) {
        var HistorialEmpleadoDialog = (function (_super) {
...
(function (PHC) {
    var Default;
    (function (Default) {
        var HistorialEmpleadoGrid = (function (_super) {
...
(function (PHC) {
    var Default;
    (function (Default) {
        var DepartamentoDialog = (function (_super) {
...
(function (PHC) {
    var Default;
    (function (Default) {
        var DepartamentoGrid = (function (_super) {
...
(function (PHC) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = PHC.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = PHC.LanguageList || (PHC.LanguageList = {}));
})(PHC || (PHC = {}));
...
(function (PHC) {
    ...
    (function (ScriptInitialization) {
        ...
        Serenity.EntityDialog.defaultLanguageList = PHC.LanguageList.getValue;
    })(ScriptInitialization = PHC.ScriptInitialization || (PHC.ScriptInitialization = {}));
})(PHC || (PHC = {}));
var PHC;
(function (PHC) {
    var Common;
...
(function (PHC) {
    ...
    PHC.BasicProgressDialog = BasicProgressDialog;
})(PHC || (PHC = {}));
var PHC;
(function (PHC) {
    var Common;
    (function (Common) {
        var BulkServiceAction = (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new PHC.BasicProgressDialog();
...
(function (PHC) {
    ...
    })(DialogUtils = PHC.DialogUtils || (PHC.DialogUtils = {}));
})(PHC || (PHC = {}));
var PHC;
(function (PHC) {
    var Common;
...
(function (PHC) {
    ...
    (function (BasicSamples) {
        ...
        }(PHC.Northwind.OrderGrid));
        BasicSamples.WrappedHeadersGrid = WrappedHeadersGrid;
    })(BasicSamples = PHC.BasicSamples || (PHC.BasicSamples = {}));
})(PHC || (PHC = {}));
var PHC;
(function (PHC) {
    var BasicSamples;
...
(function (PHC) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return PHC.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return PHC.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return PHC.Northwind.SalesByCategoryService.baseUrl; };
            /**
        ...
        var TreeGrid = (function (_super) {
            ...
            function TreeGrid(container) {
                ...
                _this.treeMixin = new Serenity.TreeGridMixin({
                    ...
                    toggleField: PHC.Northwind.OrderRow.Fields.CustomerCompanyName,
...
(function (PHC) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return PHC.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return PHC.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (PHC) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return PHC.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return PHC.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return PHC.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return PHC.Northwind.OrderService.baseUrl; };
            /**
            ...
            QuickFilterCustomization.prototype.getQuickFilters = function () {
                ...
                var fld = PHC.Northwind.OrderRow.Fields;
...
(function (PHC) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return PHC.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return PHC.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return PHC.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return PHC.Northwind.ProductService.baseUrl; };
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            PHC.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
                        ...
                        var dlg = new PHC.Northwind.OrderDialog();
                        this.initDialog(dlg);
                        dlg.loadEntityAndOpenDialog({
        ...
        var InitialValuesForQuickFilters = (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == fld.ShippingState; }).init = function (w) {
                    ...
                    w.value = PHC.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
...
(function (PHC) {
    ...
    PHC.SelectableEntityGrid = SelectableEntityGrid;
})(PHC || (PHC = {}));
...
(function (PHC) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return PHC.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return PHC.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return PHC.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return PHC.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(PHC.SelectableEntityGrid));
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(PHC.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new PHC.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new PHC.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new PHC.Northwind.OrderDialog().loadEntityAndOpenDialog({
                        CustomerID: item.CustomerID,
                    ...
                    var countryFilter = this.findQuickFilter(Serenity.LookupEditor, PHC.Northwind.OrderRow.Fields.ShipCountry);
...
(function (PHC) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return PHC.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return PHC.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return PHC.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return PHC.Northwind.ProductService.baseUrl; };
            /**
            ...
            ConditionalFormattingGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = PHC.Northwind.ProductRow.Fields;
...
(function (PHC) {
    ...
    PHC.StaticTextBlock = StaticTextBlock;
})(PHC || (PHC = {}));
var PHC;
(function (PHC) {
    var BasicSamples;
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return PHC.Northwind.CategoryRow.lookupKey;
            };
            /**
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new PHC.Northwind.OrderDetailForm(_this.idPrefix);
                ...
                _this.form.ProductID.cascadeField = PHC.Northwind.ProductRow.Fields.CategoryID;
                return _this;
        ...
        }(PHC.Northwind.OrderDetailDialog));
...
(function (PHC) {
    ...
    (function (BasicSamples) {
        ...
        }(PHC.Northwind.OrderDetailsEditor));
...
(function (PHC) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return PHC.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return PHC.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return PHC.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return PHC.Northwind.OrderService.baseUrl; };
        ...
        var ChangingLookupTextDialog = (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    var productID = Q.toId(_this.form.ProductID.value);
                    if (productID != null) {
                        _this.form.UnitPrice.value = PHC.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
                _this.form.Discount.addValidationRule(_this.uniqueName, function (e) {
                    var price = _this.form.UnitPrice.value;
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return PHC.Northwind.OrderDetailRow.localTextPrefix; };
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return PHC.Northwind.ProductRow.lookupKey;
            };
        ...
        var SerialAutoNumberDialog = (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    PHC.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
...
(function (PHC) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return PHC.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return PHC.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return PHC.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return PHC.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return PHC.Northwind.OrderService.baseUrl; };
        ...
        var PopulateLinkedDataDialog = (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(PHC.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    PHC.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return PHC.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return PHC.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return PHC.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return PHC.Northwind.OrderService.baseUrl; };
        ...
        var OtherFormOneBarDialog = (function (_super) {
            ...
            function OtherFormOneBarDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    items: Q.getForm(PHC.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    idPrefix: _this.idPrefix + "_Customer_",
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new PHC.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
            ...
            OtherFormOneBarDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(PHC.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
            ...
            OtherFormOneBarDialog.prototype.saveCustomer = function (callback, onSuccess) {
                ...
                if (!id) {
                    ...
                    PHC.Northwind.CustomerService.Update({
                        EntityId: id,
                        Entity: c
                    }, function (response) {
                        // reload customer list just in case
                        Q.reloadLookup(PHC.Northwind.CustomerRow.lookupKey);
        ...
        var GetInsertedRecordIdDialog = (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    PHC.Northwind.CategoryService.Retrieve({
        ...
        var DefaultValuesInNewGrid = (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: PHC.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: PHC.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var chai = PHC.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = PHC.Northwind.EmployeeRow.getLookup().items
...
(function (PHC) {
    ...
    })(Administration = PHC.Administration || (PHC.Administration = {}));
})(PHC || (PHC = {}));
var PHC;
(function (PHC) {
    var Administration;
...
(function (PHC) {
    ...
    })(Authorization = PHC.Authorization || (PHC.Authorization = {}));
})(PHC || (PHC = {}));
var PHC;
(function (PHC) {
    var Administration;
...
(function (PHC) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return PHC.Northwind.CustomerEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['CategoryID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return BasicSamples.FilteredLookupDetailEditor; }]].forEach(function (x) { return Object.defineProperty(FilteredLookupInDetailForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = PHC.BasicSamples || (PHC.BasicSamples = {}));
})(PHC || (PHC = {}));
var PHC;
(function (PHC) {
...
(function (PHC) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return PHC.Northwind.CustomerEditor; }], ['CustomerContactName', function () { return Serenity.StringEditor; }], ['CustomerContactTitle', function () { return Serenity.StringEditor; }], ['CustomerCity', function () { return Serenity.StringEditor; }], ['CustomerRegion', function () { return Serenity.StringEditor; }], ['CustomerCountry', function () { return Serenity.StringEditor; }], ['CustomerPhone', function () { return Serenity.StringEditor; }], ['CustomerFax', function () { return Serenity.StringEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['RequiredDate', function () { return Serenity.DateEditor; }], ['EmployeeID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return PHC.Northwind.OrderDetailsEditor; }]].forEach(function (x) { return Object.defineProperty(PopulateLinkedDataForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = PHC.BasicSamples || (PHC.BasicSamples = {}));
})(PHC || (PHC = {}));
var PHC;
(function (PHC) {
...
(function (PHC) {
    ...
    (function (BasicSamples) {
        ...
        [['StaticText', function () { return PHC.StaticTextBlock; }], ['SomeInput', function () { return Serenity.StringEditor; }], ['HtmlList', function () { return PHC.StaticTextBlock; }], ['FromLocalText', function () { return PHC.StaticTextBlock; }], ['DisplayFieldValue', function () { return PHC.StaticTextBlock; }]].forEach(function (x) { return Object.defineProperty(StaticTextBlockForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = PHC.BasicSamples || (PHC.BasicSamples = {}));
})(PHC || (PHC = {}));
var PHC;
(function (PHC) {
...
(function (PHC) {
    var Default;
    (function (Default) {
        var DepartamentoForm = (function (_super) {
...
(function (PHC) {
    ...
    (function (Default) {
        ...
        (function (DepartamentoRow) {
            ...
            DepartamentoRow.nameProperty = 'Nombre';
...
(function (PHC) {
    ...
    (function (Default) {
        ...
        [,
            ...
            ['Domicilio', function () { return Serenity.StringEditor; }],
...
(function (PHC) {
    var Default;
    (function (Default) {
        var HistorialEmpleadoForm = (function (_super) {
        ...
        [,
            ['FechaIngreso', function () { return Serenity.DateEditor; }],
            ['FechaEgreso', function () { return Serenity.DateEditor; }],
...
(function (PHC) {
    var Default;
    (function (Default) {
        var PuestoForm = (function (_super) {
        ...
        [,
            ...
            ['EsResponsableDpto', function () { return Serenity.BooleanEditor; }],
...
(function (PHC) {
    var Default;
    (function (Default) {
        var PuestoTareaForm = (function (_super) {
...
(function (PHC) {
    var Default;
    (function (Default) {
        var RequerimientoForm = (function (_super) {
...
(function (PHC) {
    var Default;
    (function (Default) {
        var RequerimientoPuestoForm = (function (_super) {
...
(function (PHC) {
    ...
    (function (Default) {
        ...
        (function (RequerimientoRow) {
            ...
            RequerimientoRow.nameProperty = 'Descripcion';
...
(function (PHC) {
    ...
    (function (Default) {
        ...
        (function (TareaRow) {
            ...
            TareaRow.nameProperty = 'Descripcion';
...
(function (PHC) {
    var Default;
    (function (Default) {
        var UsuarioForm = (function (_super) {
        ...
        [,
            ...
            ['Contraseña', function () { return Serenity.StringEditor; }],
            ['EsAdministrador', function () { return Serenity.BooleanEditor; }],
            ['Habilitado', function () { return Serenity.BooleanEditor; }],
...
(function (PHC) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnum(Gender, 'PHC.Northwind.Entities.Gender');
    })(Northwind = PHC.Northwind || (PHC.Northwind = {}));
})(PHC || (PHC = {}));
var PHC;
(function (PHC) {
...
//# sourceMappingURL=PHC.Web.js.map